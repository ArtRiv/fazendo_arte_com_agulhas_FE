        ...
        <footer className="w-full [background:var(--gradient-background)] footer">
            <div className="max-w-[100rem] h-full my-0 mx-auto px-24 py-5 flex flex-col items-center">
                <h2 className="text-3xl text-center">
                    Siga nosso <a className='' href="https://www.instagram.com/fazendoartecagulhas/">Instagram!</a>
                </h2>
                <p className="mt-4 max-w-1/2 w-1/2 text-sm text-zinc-600 text-center">
                    Olá! Não se esqueça de nos acompanhar no Instagram, <a className="" target="_blank" href="https://www.instagram.com/fazendoartecagulhas/">@fazendoartecagulhas</a>
